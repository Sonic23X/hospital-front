                ...
                <div class="card height-equal">
                  ...
                  <div class="card-body">
                    <form class="mega-vertical">
                      <div class="row">
                        <div class="col-sm-12"><p class="mega-title m-b-5">Delivery Option</p></div>
                        <div class="col-sm-6">
                          <div class="card">
                            <div class="media p-20">
                              <div class="radio radio-primary me-3">
                                <input id="radio23" type="radio" name="radio1" value="option1"><label for="radio23"></label>
                              </div>
                          ...
                          <div class="card">
                            <div class="media p-20">
                              <div class="radio radio-secondary me-3">
                                <input id="radio24" type="radio" name="radio1" value="option1"><label for="radio24"></label>
                              </div>
                              <div class="media-body">
                          ...
                          <div class="card">
                            <div class="media p-20">
                              <div class="radio radio-info me-3">
                                <input id="radio5" type="radio" name="radio1" value="option1"><label for="radio5"></label>
                              </div>
                              <div class="media-body">
                        ...
                        <div class="col-sm-12"><p class="mega-title m-b-5">Buying Option</p></div>
                        <div class="col-sm-6">
                          <div class="card">
                            <div class="media p-20">
                              <div class="radio radio-warning me-3">
                                <input id="radio26" type="radio" name="radio1" value="option1"><label for="radio26"></label>
                              </div>
                              <div class="media-body">
                          ...
                          <div class="card mb-0">
                            <div class="media p-20">
                              <div class="radio radio-danger me-3">
                                <input id="radio27" type="radio" name="radio1" value="option1"><label for="radio27"></label>
                              </div>
                              <div class="media-body">
