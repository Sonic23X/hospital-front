<template>
     <div class="col-sm-6 col-xl-3 xl-50 col-lg-6 box-col-6">
                <div class="card social-widget-card">
                  <div class="card-body">
                    <div class="media">
                      <div class="social-font"><img src="../../../assets/images/svg-icon/2.svg" alt=""></div>
                    ...
                    <div class="row">
                      <div class="col text-center">
                        ...
                        <h5 class="counter mb-0 font-roboto font-primary mt-1">
                             <number class="bold counter" ref="number1" :from="0" :to="6589" :duration="5" :delay="0" easing="Power1.easeOut" />
                        </h5>
                      </div>
                      <div class="col text-center">
