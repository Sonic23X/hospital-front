                        ...
                        <div class="col-xl-12">
                          <div class="card">
                            <div class="card-header">
                              <h5 class="mb-0 p-0">
                                <button class="btn btn-link" data-bs-toggle="collapse" data-bs-target="#collapseicon1" :class="[isActive ? 'active' : '', 'collapsible']" v-on:click="toggle">Knowledge Categories</button>
                              </h5>
                            </div>
