                        ...
                        <div class="mb-3">
                          <div class="col-form-label"> 
                            <label>Category:</label>
                             <multiselect  v-model="multiValue" tag-placeholder="Add this as new tag" placeholder="Select Your Name" label="name" track-by="code" :options="options" :multiple="true" :taggable="true" ></multiselect>
                          </div>
                        </div>
...
<script>
 import CKEditor from '@ckeditor/ckeditor5-vue';
  ...
  import dropzonFile from "../../dropzonFile.vue"
export default {
     components: {
