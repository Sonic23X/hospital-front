<template>
                            ...
                            <div class="row">
                              <div class="col-xl-4 col-lg-6" id="#top-home" v-for="(project,index) in doingprojects" :key="index" :class="index < 3 ? 'mb-4' : ''">
                                <div class="project-box">
                                  <span class="badge" :class="'badge-'+project.type">{{ project.badge }}</span>
                                  <h6>{{ project.title }}</h6>
                                  <div class="media">
                                    <img class="img-20 me-2 rounded-circle" :src='getImgUrl(project.img)' alt="" title="">
