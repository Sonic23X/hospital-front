                          ...
                          <div class="card-body support-ticket-font">
                            <div class="row">
                              <div class="col-5"><span>Smooth</span>
                                <h3 class="total-num counter"><number class="counter" ref="number1" :from="0" :to="2060" :duration="5" :delay="0" easing="Power1.easeOut"/></h3>
                              </div>
                              <div class="col-7">
                                <div class="text-end">
                                  <ul>
                          ...
                          <div class="card-body support-ticket-font">
                            <div class="row">
                              <div class="col-5"><span>Done</span>
                                <h3 class="total-num counter"><number class="counter" ref="number1" :from="0" :to="5600" :duration="5" :delay="0" easing="Power1.easeOut"/></h3>
                              </div>
                              <div class="col-7">
                                <div class="text-end">
                                  <ul>
                          ...
                          <div class="card-body support-ticket-font">
                            <div class="row">
                              <div class="col-5"><span>Cancle</span>
                                <h3 class="total-num counter"><number class="counter" ref="number1" :from="0" :to="2560" :duration="5" :delay="0" easing="Power1.easeOut"/></h3>
                              </div>
                              <div class="col-7">
                                <div class="text-end">
                                  <ul>
