              ...
              <table class="table  display" id="basic-1">
                ...
                <tbody>
                   <tr v-for="row in get_rows" :key="row">
                     <td><router-link to="/ecommerce/details/1"><img class="img-fluid img-30" :src="require('../../../assets/images/product/' + row.img)" :alt="row.product"></router-link></td>
                     <td>
...
<script>
import orderHistory from "@/mixins/orderHistory";
