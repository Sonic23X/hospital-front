  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="owl-carousel owl-theme" id="owl-carousel-14">
        <swiper :autoHeight="true" :slidesPerView="1" :spaceBetween="30" :pagination="{
          clickable: true,
        }" :modules="modules" class="mySwiper">
          <swiper-slide v-for="item in owlcarousel" :key="item">
            <div class="item"><img :src="getImageUrl(item.img)" style="height:auto;  width: 1511px;  border-radius: 5px;"
                alt=""></div>
          </swiper-slide>
        </swiper>
      </div>
