  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="owl-carousel owl-theme" id="owl-carousel-15">
        <swiper :autoHeight="true" :mousewheel="true" :slidesPerView="5" :spaceBetween="30" :pagination="{
          clickable: true,
        }" :modules="modules" class="mySwiper">
          <swiper-slide v-for="item in owlcarousel" :key="item">
            <div class="item"><img :src="getImageUrl(item.img)" style="height:200px; width: 294.2px;  border-radius: 5px;"
                alt=""></div>
          </swiper-slide>
        </swiper>
      </div>
