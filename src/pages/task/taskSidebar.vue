<template>
  <div class="col-xl-3 box-col-3 xl-30">
    <div class="email-sidebar"><a class="btn btn-primary email-aside-toggle" @click="collapseFilter()">bookmark filter</a>
              ...
              <ul class="nav main-menu custom-scrollbar" role="tablist">
                <li class="nav-item">
                  <button class="btn-primary badge-light btn-block btn-mail w-100" type="button" data-bs-toggle="modal"
                    data-bs-target="#bookmarkModal"><vue-feather class="me-2" type="check-circle"></vue-feather>New
                    Task</button>
        ...
        <div class="ps-0">
          <div class="tab-content">
            <div class="tab-pane fade" id="pills-created"
              v-bind:class="(activeclass === 'pills_created') ? 'active show' : ''" role="tabpanel"
...
import newsLetter from "./newsView.vue"
