              ...
              <ul class="nav main-menu contact-options" role="tablist">
                <li class="nav-item">
                  <button class="btn-primary badge-light btn-block btn-mail w-100" type="button" data-bs-toggle="modal"
                    data-bs-target="#contactModal"><vue-feather class="me-2" type="users"></vue-feather> New
                    Contacts</button>
                ...
                <li><a id="pills-personal-tab" data-bs-toggle="pill" href="#pills-personal" role="tab"
                    aria-controls="pills-personal" aria-selected="true"><span class="title"
                      v-on:click="say('pills_personal')"> Personal</span></a></li>
                <li>
                  <button class="btn btn-category" type="button" data-bs-toggle="modal"
                    data-bs-target="#categoryModal1"><span class="title"> + Add Category</span></button>
                ...
                <li><a class="show" id="pills-organization-tab" data-bs-toggle="pill" href="#pills-organization"
                    role="tab" aria-controls="pills-organization" aria-selected="false"><span class="title"
                      v-on:click="say('pills_organization')"> Organization</span></a></li>
        ...
        <div class="ps-0">
          <div class="tab-content">
            <div class="tab-pane fade " id="pills-personal"
              v-bind:class="(activeclass === 'pills_personal') ? 'active show' : ''" role="tabpanel"
