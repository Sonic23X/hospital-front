      ...
      <div class="row list-persons" id="addcon">
        <div class="col-xl-4 xl-50 col-md-5 box-col-6">
          <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <a class="contact-tab-0 nav-link" :class="contact.active" id="v-pills-user-tab" data-bs-toggle="pill"
              :href="'#v-pills-user'+contact.id" role="tab" aria-controls="v-pills-user" aria-selected="true"
              ...
              <div class="media"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_0"
                ...
                <div class="media-body">
                  <h6> <span class="first_name_1">{{contact.name1}}</span> <span
                      class="last_name_1">{{contact.name2}}</span></h6>
