<template>
     <div class="mode animated backOutRight">
                 ...
                 <svg class="lighticon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" v-show="mixLayout == 'light-only'" @click="customizeMixLayout('dark-only')">
                    <g>
                      <g>                 
                  ...
                  <svg class="darkicon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" v-show="mixLayout == 'dark-only'" @click="customizeMixLayout('light-only')">
