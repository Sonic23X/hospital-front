<template>
  <div class="tab-pane fade" :class="{ 'active show': customizer == 'colors' }" id="c-pills-home">
    ...
    <ul class="layout-grid unlimited-color-layout">
      <input id="ColorPicker1" type="color" value="#6362e7" name="Background" />
      <input id="ColorPicker2" type="color" value="#ffc500" name="Background" />
      <button type="button" class="color-apply-btn btn btn-primary color-apply-btn" @click="customizeColor">
        Apply
      </button>
    </ul>
